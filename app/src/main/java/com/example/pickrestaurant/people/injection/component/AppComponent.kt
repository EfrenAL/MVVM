...
import com.example.pickrestaurant.people.injection.module.FragmentModule
 ...
 */
@Singleton
@Component(modules = arrayOf(AndroidInjectionModule::class, BuildersModule::class, AppModule::class, NetworkModule::class, FragmentModule::class))
